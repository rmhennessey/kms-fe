...
const World = () => {
	return (
		<>
			<Meta
				title='Miniverse Wiki | Podcast Jesus'
				description='Minifans, Mincels, Parody Accounts, Enemies and more'
				keywords='minifans, mincels, podcast jesus'
			/>
			<Container style={{ marginTop: '30px' }}>
				<div style={{ marginBottom: '30px' }}>
					<h1>The Minverse World</h1>
					<p>
						Meet the cast of Minifans, Mincels, Parody Accounts, Enemies, and
						more from the KMS Miniverse.
					</p>
				</div>
				<Tabs
					defaultActiveKey='a'
